...
5. Create `%Y%m%d_review_backend.md` in the plan directory (format at end of this file)
...
4. Update `%Y%m%d_review_backend.md`, present summary to user
...
2. Update `%Y%m%d_review_backend.md`: mark approved, record final status per reviewer
3. Present summary: iterations, findings addressed vs. deferred, outstanding suggestions
4. Ask: "Ready to commit?"

## %Y%m%d_review_backend.md Format
...
- Track iterations in %Y%m%d_review_backend.md

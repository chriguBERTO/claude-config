...
5. Create `%Y%m%d_review_frontend.md` in the plan directory (format at end of this file)
...
4. Update `%Y%m%d_review_frontend.md`, present summary to user
...
2. Update `%Y%m%d_review_frontend.md`: mark approved, record final status per reviewer
3. Present summary: iterations, findings addressed vs. deferred, outstanding suggestions
4. Ask: "Ready to commit?"

## %Y%m%d_review_frontend.md Format
...
- Track iterations in %Y%m%d_review_frontend.md
